...
from genetic_algorithm.fitness.soft_constraints import check_unequal_day_night_shifts, check_two_night_shifts, check_weekend_free, check_hierarchy_mismatch, check_leave_days
from config.algorithm_config import initial_fitness_score

def calculate_fitness(schedule, doctors, doctor_mapping, leave_dict, log):
    ...
    fitness_score -= check_leave_days(schedule, leave_dict, log)
