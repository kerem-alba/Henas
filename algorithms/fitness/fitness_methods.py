from algorithms.fitness.hard_constraints import (
    check_duplicate_shifts,
    check_consecutive_shifts,
    check_three_consecutive_night_shifts,
    check_coverage_in_shift,
)
from algorithms.fitness.soft_constraints import check_unequal_day_night_shifts, check_two_night_shifts, check_weekend_free, check_hierarchy_mismatch
